  ...
  return (
    ...
    animate="visible"
      ...
      <div className="w-4/12">
        <a href="#"> <img className="h-48 w-48 mb-4" src={image} alt="" /></a>
      ...
      <div className="w-3/12 flex justify-end items-center  ">
            ...
            <a href="#" className="mx-4 	font-semibold tracking-wider hover:text-purple-700	">Register Now!</a>
           <a href="#" className="mx-4 font-semibold tracking-wider	hover:text-purple-700">Log In</a>
      </div>
