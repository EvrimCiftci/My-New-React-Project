...
<div className="flex flex-wrap w-screen h-auto justify-center items-center ">
      ...
      <motion.div
        ...
        <div className="shadow-xl p-4 mb-4 bg-gray-200 rounded-lg w-9/12 ">
          <Accordion  title="Is Whatabill's software something I need to install" answer="no it's not , it's completely webapp that you can use on tour browser " />
        </div>
         <div className="shadow-xl  p-4 my-4 bg-gray-200 rounded-lg w-9/12 ">
